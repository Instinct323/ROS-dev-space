...
set(_exported_dependencies "rviz_ogre_vendor;rviz_assimp_vendor;eigen3_cmake_module;Eigen3;resource_retriever;ament_index_cpp")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rviz_rendering_INCLUDE_DIRS "${_include_dirs}")
          endif()
